...
export default function UserProductOrder() {
    ...
    function addProductToCart(productId) {
        let cartIem = cartList.find(item => item.productId === productId);
        if (cartIem) {
            addQuantity(productId);
        } else {
            let product = productList.find(item => item.productId === productId);
            let newCartIem = {
            ...
            setCartList(prevState => [...prevState, newCartIem]);
            setCartPriceTotal(prevState => prevState + product.productPrice);
        }
    }
    ...
    function removeCartIem(productId) {
            ...
            <div className="user-product-order__container">
                ...
                <div className="user-product-order__container__product-list">
                    ...
                    <div className="user-product-order__container__product-list__list">
                        ...
                        <div className="user-product-order__container__product-list__list__item" key={item.productId}>
                            ...
                            <div className="user-product-order__container__product-list__list__item__button-group">
                                <div className="user-product-order__container__product-list__list__item__button-group__add-to-cart-button" onClick={() => addProductToCart(item.productId)}>
                                    Add to cart
                                </div>
                            </div>
                        </div>
            ...
            <div className="user-product-order__cart-modal" style={cartModalState ? {} : {display: 'none'}}>
                <div className="user-product-order__cart-modal__form">
                    ...
                    <div className="user-product-order__cart-modal__form__cart-detail">
                        {cartList.map(item => (
                        <div className="user-product-order__cart-modal__form__cart-detail__item" key={item.productId}>
                            ...
                            <div className="user-product-order__cart-modal__form__cart-detail__item__button-group">
                                <div className="user-product-order__cart-modal__form__cart-detail__item__button-group__first">
                                    <div className="user-product-order__cart-modal__form__cart-detail__item__button-group__first__remove-button" onClick={() => removeCartIem(item.productId)}>
                                        X
                                    </div>
                                </div>
                                <div className="user-product-order__cart-modal__form__cart-detail__item__button-group__quantity">
                                    <div className="user-product-order__cart-modal__form__cart-detail__item__button-group__quantity__subtract-button" onClick={() => subtractQuantity(item.productId)}>
                                        -
                                    </div>
                                    <div className="user-product-order__cart-modal__form__cart-detail__item__button-group__quantity__label">
                                        {item.quantity}
                                    </div>
                                    <div className="user-product-order__cart-modal__form__cart-detail__item__button-group__quantity__add-button" onClick={() => addQuantity(item.productId)}>
                                        +
                                    </div>
                                </div>
                            </div>
