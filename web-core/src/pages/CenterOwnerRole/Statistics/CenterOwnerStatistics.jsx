...
export default function CenterOwnerStatistics() {
    ...
    async function loadTodayTotalBooking() {
        ...
        let url = API_URL.BASE + API_URL.COURT_BOOKING.BASE + API_URL.COURT_BOOKING.CENTER_OWNER + API_URL.COURT_BOOKING.STATISTICS + API_URL.COURT_BOOKING.TODAY;
    ...
    async function loadTodayTotalProductOrder() {
        ...
        let url = API_URL.BASE + API_URL.COURT_BOOKING_PRODUCT_ORDER.BASE + API_URL.COURT_BOOKING_PRODUCT_ORDER.CENTER_OWNER + API_URL.COURT_BOOKING_PRODUCT_ORDER.STATISTICS + API_URL.COURT_BOOKING_PRODUCT_ORDER.TODAY;
        let searchParams = new URLSearchParams();
    ...
    async function submitCourtBookingStatisticsFilterValue() {
        ...
        let url = API_URL.BASE + API_URL.COURT_BOOKING_PRODUCT_ORDER.BASE + API_URL.COURT_BOOKING_PRODUCT_ORDER.CENTER_OWNER + API_URL.COURT_BOOKING_PRODUCT_ORDER.COURT_BOOKING + API_URL.COURT_BOOKING_PRODUCT_ORDER.STATISTICS;
        let searchParams = new URLSearchParams();
    ...
    async function submitProductOrderStatisticsFilterValue() {
        ...
        let url = API_URL.BASE + API_URL.COURT_BOOKING_PRODUCT_ORDER.BASE + API_URL.COURT_BOOKING_PRODUCT_ORDER.CENTER_OWNER + API_URL.COURT_BOOKING_PRODUCT_ORDER.PRODUCT_ORDER + API_URL.COURT_BOOKING_PRODUCT_ORDER.STATISTICS;
        let searchParams = new URLSearchParams();
        ...
        <div className="center-owner-statistics">
            <div className="center-owner-statistics__container">
                <div className="center-owner-statistics__container__header">
                    ...
                    <div className="center-owner-statistics__container__header__today-stats">
                        <div className="center-owner-statistics__container__header__today-stats__total-booking">
                            <div className="center-owner-statistics__container__header__today-stats__total-booking__info">
                                <div className="center-owner-statistics__container__header__today-stats__total-booking__info__count">
                                    {todayStats.bookingCount ? todayStats.bookingCount : 0}
                                </div>
                                <div className="center-owner-statistics__container__header__today-stats__total-booking__info__value-container">
                                    <div className="center-owner-statistics__container__header__today-stats__total-booking__info__value-container__value">
                                        {todayStats.bookingRevenueCount ? todayStats.bookingRevenueCount : 0} ₫
                                    </div>
                                </div>
                            </div>
                            <div className="center-owner-statistics__container__header__today-stats__total-booking__label">
                                Total booking today
                            </div>
                        </div>
                        <div className="center-owner-statistics__container__header__today-stats__total-product-order">
                            <div className="center-owner-statistics__container__header__today-stats__total-product-order__info">
                                <div className="center-owner-statistics__container__header__today-stats__total-product-order__info__count">
                                    {todayStats.productOrderCount ? todayStats.productOrderCount : 0}
                                </div>
                                <div className="center-owner-statistics__container__header__today-stats__total-product-order__info__value-container">
                                    <div className="center-owner-statistics__container__header__today-stats__total-product-order__info__value-container__value">
                                        {todayStats.productOrderRevenueCount ? todayStats.productOrderRevenueCount : 0} ₫
                                    </div>
                                </div>
                            </div>
                            <div className="center-owner-statistics__container__header__today-stats__total-product-order__label">
                                Total product order today
                            </div>
                        </div>
                    </div>
                </div>
                <div className="center-owner-statistics__container__graphs">
                    <div className="center-owner-statistics__container__graphs__court-booking">
                        <div className="center-owner-statistics__container__graphs__court-booking__header">
                            <div className="center-owner-statistics__container__graphs__court-booking__header__label">
                                Court booking
                            </div>
                            <div className="center-owner-statistics__container__graphs__court-booking__header__filters">
                                <div className="center-owner-statistics__container__graphs__court-booking__header__filters__label" onClick={() => setCourtBookingStatsFilterModalState(true)}>
                                    Filters
                                </div>
                                <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu" style={courtBookingStatsFilterModalState ? {} : {display: 'none'}} ref={courtBookingStatsFilterModalStateRef}>
                                    <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__clear-all">
                                        <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__clear-all__button" onClick={() => clearAllCourtBookingStatisticFilter()}>
                                            Clear all
                                        </div>
                                    </div>
                                    <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__center">
                                        <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__center__label">
                                            Center:  {courtBookingStatisticsFilterValue.centerId ? `id: ${courtBookingStatisticsFilterValue.centerId}` : ''}
                                        </div>
                                        <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__center__input">
                                            <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__center__input__button" onClick={() => setCourtBookingStatsCenterFilterModalState(true)}>
                                                <FontAwesomeIcon icon={faChevronRight} />
                                            </div>
                                            <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__center__input__option" style={courtBookingStatsCenterFilterModalState ? {} : {display: 'none'}} ref={courtBookingStatsCenterFilterModalStateRef}>
                                                ...
                                                {courtBookingStatsCenterFilterDropdownList.map(item => (
                                                    <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__center__input__option__item" onClick={() => onCourtBookingStatisticsFilterSelect(item.id)}>
                                                        {item.name}
                                                    </div>
                                                ))}
                                            </div>
                                    ...
                                    <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__range">
                                        <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__range__label">
                                        ...
                                        <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__range__input">
                                            <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__range__input__button" onClick={() => setCourtBookingStatsRangeFilterModalState(true)}>
                                                <FontAwesomeIcon icon={faChevronRight} />
                                            </div>
                                            <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__range__input__option" style={courtBookingStatsRangeFilterModalState ? {} : {display: 'none'}} ref={courtBookingStatsRangeFilterModalStateRef}>
                                                <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__range__input__option__type__daily">
                                                    From:
                                    ...
                                    <div className="center-owner-statistics__container__graphs__court-booking__header__filters__menu__button" onClick={() => submitCourtBookingStatisticsFilterValue()}>
                                        Search
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="center-owner-statistics__container__graphs__court-booking__graph">
                    ...
                    <div className="center-owner-statistics__container__graphs__product-order">
                        <div className="center-owner-statistics__container__graphs__product-order__header">
                            <div className="center-owner-statistics__container__graphs__product-order__header__label">
                                Product order
                            </div>
                            <div className="center-owner-statistics__container__graphs__product-order__header__filters">
                                <div className="center-owner-statistics__container__graphs__product-order__header__filters__label" onClick={() => setProductOrderStatsFilterModalState(true)}>
                                    Filters
                                </div>
                                <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu" style={productOrderStatsFilterModalState ? {} : {display: 'none'}} ref={productOrderStatsFilterModalStateRef}>
                                    <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__clear-all">
                                        <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__clear-all__button" onClick={() => clearAllProductOrderStatisticsFilter()}>
                                            Clear all
                                        </div>
                                    </div>
                                    <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__center">
                                        <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__center__label">
                                            Center: {productOrderStatisticsFilterValue.centerId ? `id: ${productOrderStatisticsFilterValue.centerId}` : ''}
                                        </div>
                                        <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__center__input">
                                            <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__center__input__button" onClick={() => setProductOrderStatsCenterFilterModalState(true)}>
                                                <FontAwesomeIcon icon={faChevronRight} />
                                            </div>
                                            <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__center__input__option" style={productOrderStatsCenterFilterModalState ? {} : {display: 'none'}} ref={productOrderStatsCenterFilterModalStateRef}>
                                                ...
                                                {productOrderStatsCenterFilterDropdownList.map(item => (
                                                    <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__center__input__option__item" onClick={() => onProductOrderStatisticsFilterSelect(item.id)}>
                                                        {item.name}
                                                    </div>
                                                ))}
                                            </div>
                                    ...
                                    <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__range">
                                        <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__range__label">
                                        ...
                                        <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__range__input">
                                            <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__range__input__button" onClick={() => setProductOrderStatsRangeFilterModalState(true)}>
                                                <FontAwesomeIcon icon={faChevronRight} />
                                            </div>
                                            <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__range__input__option" style={productOrderStatsRangeFilterModalState ? {} : {display: 'none'}} ref={productOrderStatsRangeFilterModalStateRef}>
                                                <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__range__input__option__type__daily">
                                                    From:
                                    ...
                                    <div className="center-owner-statistics__container__graphs__product-order__header__filters__menu__button" onClick={() => submitProductOrderStatisticsFilterValue()}>
                                        Search
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="center-owner-statistics__container__graphs__product-order__graph">
                            <ResponsiveContainer width='100%' height={400}>
                                <PieChart width={400} height={400}>
                                    <Pie
                    ...
                    <div className="center-owner-statistics__container__graphs__revenue">
                        <div className="center-owner-statistics__container__graphs__revenue__header">
                            <div className="center-owner-statistics__container__graphs__revenue__header__label">
                                Revenue
                            </div>
                            <div className="center-owner-statistics__container__graphs__revenue__header__filters">
                                <div className="center-owner-statistics__container__graphs__revenue__header__filters__label" onClick={() => setRevenueStatsFilterModalState(true)}>
                                    Filters
                                </div>
                                <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu" style={revenueStatsFilterModalState ? {} : {display: 'none'}} ref={revenueStatsFilterModalStateRef}>
                                    <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__clear-all">
                                        <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__clear-all__button" onClick={() => clearAllRevenueStatisticFiliter()}>
                                            Clear all
                                        </div>
                                    </div>
                                    <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__center">
                                        <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__center__label">
                                            Center: {revenueStatisticsFilterValue.centerId ? `id: ${revenueStatisticsFilterValue.centerId}` : ''}
                                        </div>
                                        <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__center__input">
                                            <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__center__input__button" onClick={() => setRevenueStatsCenterFilterModalState(true)}>
                                                <FontAwesomeIcon icon={faChevronRight} />
                                            </div>
                                            <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__center__input__option" style={revenueStatsCenterFilterModalState ? {} : {display: 'none'}} ref={revenueStatsCenterFilterModalStateRef}>
                                                ...
                                                {revenueStatsCenterFilterDropdownList.map(item => (
                                                    <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__center__input__option__item" onClick={() => onRevenueStatisticsFilterSelect(item.id)}>
                                                        {item.name}
                                                    </div>
                                                ))}
                                            </div>
                                    ...
                                    <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range">
                                        <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__label">
                                        ...
                                        <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input">
                                            <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__button" onClick={() => setRevenueStatsRangeFilterModalState(true)}>
                                                <FontAwesomeIcon icon={faChevronRight} />
                                            </div>
                                            <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option" style={revenueStatsRangeFilterModalState ? {} : {display: 'none'}} ref={revenueStatsRangeFilterModalStateRef}>
                                                <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option__type">
                                                    <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option__type__label">
                                                        Frequency
                                                    </div>
                                                    <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option__type__value">
                                                        <label className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option__type__value__item">
                                                ...
                                                <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option__type__daily" style={revenueStatsRangeFrequencyOption === 'daily' ? {} : {display: 'none'}}>
                                                    From:
                                                ...
                                                <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option__type__monthly" style={revenueStatsRangeFrequencyOption === 'monthly' ? {} : {display: 'none'}}>
                                                    From:
                                                ...
                                                <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__range__input__option__type__yearly" style={revenueStatsRangeFrequencyOption === 'yearly' ? {} : {display: 'none'}}>
                                                    From:
                                    ...
                                    <div className="center-owner-statistics__container__graphs__revenue__header__filters__menu__button" onClick={() => submitRevenueStatisticsFilterValue()}>
                                        Search
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="center-owner-statistics__container__graphs__revenue__graph">
